...
function [best,fmin,cg_curve]=BBA_InitialGuss(n, A, r, d, Max_iter, CostFunction,data,Initial_Guss_Binary)
...
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %
% % % % initial guss
Sol(1,:)=Initial_Guss_Binary;

% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
parfor i=1:n
    Fitness(i)=CostFunction(Sol(i,:),data);
end
...
while (N_iter<Max_iter)
        ...
        parfor i=1:n
            Fnew_temp(i)=CostFunction(Sol(i,:),data); % Evaluate new solutions
        end
        
        for i=1:n
%            Fnew=CostFunction(Sol(i,:),data); % Evaluate new solutions
           Fnew=Fnew_temp(i);
